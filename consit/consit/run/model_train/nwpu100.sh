...
rm -rf /public/home/lsy/myj/code_dsl/data/semivoc/unlabel_prepared_annos/Industry/annotations/full2_nwpu100/
...
# 进行修改，需要使用绝对路径进行计算
cp -r /public/home/lsy/myj/code_dsl/DSL/workdir_voc/fullnwpu/epoch_45.pth-unlabeled.bbox.json_thres0.1_annos/  /public/home/lsy/myj/code_dsl/data/semivoc/unlabel_prepared_annos/Industry/annotations/full2_nwpu100/
...
CONFIG=configs/fcos_semi/voc/nwpu100.py
#WORKDIR=workdir_coco/sunzicheng
WORKDIR=workdir_voc/train2_nwpu100
GPU=2
