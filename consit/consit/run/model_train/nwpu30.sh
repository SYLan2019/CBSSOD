...
rm -rf /public/home/lsy/myj/code_dsl/data/semivoc/unlabel_prepared_annos/Industry/annotations/full2_nwpu30/
...
# 进行修改，需要使用绝对路径进行计算
cp -r /public/home/lsy/myj/code_dsl/DSL/workdir_voc/r50_caffe_mslonger_tricks_30trainnwpu_built_in/epoch_60.pth-unlabeled.bbox.json_thres0.1_annos/  /public/home/lsy/myj/code_dsl/data/semivoc/unlabel_prepared_annos/Industry/annotations/full2_nwpu30/
...
CONFIG=configs/fcos_semi/voc/nwpu30.py
#WORKDIR=workdir_coco/sunzicheng
WORKDIR=workdir_voc/train2_nwpu30
GPU=2
