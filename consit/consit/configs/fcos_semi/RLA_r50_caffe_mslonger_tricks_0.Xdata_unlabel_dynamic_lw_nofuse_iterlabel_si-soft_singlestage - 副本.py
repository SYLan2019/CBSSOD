model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        pretrained='/public/home/lsy/myj/code_dsl/consit/workdir_coco/r50_caffe_mslonger_tricks_0.1data/epoch_100.pth'),
    neck=dict(
        type='FPN',
...
## consit-style data root; recommend to use absolute path
