...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/public/home/lsy/myj/code_dsl/NWPU/semivoc/prepared_annos/train_100.txt',
        ann_path='/public/home/lsy/myj/code_dsl/NWPU/semivoc/prepared_annos/annotations/full/',
        labelmapper = '/public/home/lsy/myj/code_dsl/NWPU/mmdet_category_info.json',
        img_prefix = '/public/home/lsy/myj/code_dsl/NWPU/VOC2007/JPEGImages/',
        pipeline = train_pipeline,
        ),
    unlabel_train=dict(
        type=dataset_type,
        ann_file= '/public/home/lsy/myj/code_dsl/NWPU/semivoc/unlabel_prepared_annos/unlabel.txt',
        ann_path= '/public/home/lsy/myj/code_dsl/data/semivoc/unlabel_prepared_annos/Industry/annotations/full2_nwpu100/',
        labelmapper = '/public/home/lsy/myj/code_dsl/NWPU/mmdet_category_info.json',
        img_prefix = '/public/home/lsy/myj/code_dsl/NWPU/VOC2007/JPEGImages/',
    ...
    unlabel_pred=dict(
        ...
        #这里也有待商榷
        num_gpus = 2,
        image_root_path ='/public/home/lsy/myj/code_dsl/NWPU/VOC2007/JPEGImages/',
        #这个文件有待商榷******************************************
        #image_list_file = 'data_list/voc_semi/voc12_trainval.json',
        #myj 2023.6.6 读取未标记图像列表文件
        image_list_file = '/public/home/lsy/myj/code_dsl/NWPU/semivoc/unlabel_prepared_annos/unlabel.txt',
        anno_root_path = '/public/home/lsy/myj/code_dsl/data/semivoc/unlabel_prepared_annos/Industry/annotations/full2_nwpu100/',
        category_info_path = '/public/home/lsy/myj/code_dsl/NWPU/mmdet_category_info.json',
        infer_score_thre=0.1,
        save_file_format="json",
        pipeline = test_pipeline,
        eval_config ={"iou":[0.6]},
        img_path ='/public/home/lsy/myj/code_dsl/NWPU/VOC2007/JPEGImages/',
