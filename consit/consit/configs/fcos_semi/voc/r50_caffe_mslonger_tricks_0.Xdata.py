...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='VOCDataset',
            ann_file='/public/home/lsy/myj/code_dsl/ori_data/VOCdevkit2007/VOC2007/ImageSets/Main/trainval.txt',
    ...
    #         dataset=dict(
    #             type='VOCDataset',
    #             ann_file='/public/home/lsy/myj/code_dsl/NWPU/VOC2007/ImageSets/Main/train_all.txt',
