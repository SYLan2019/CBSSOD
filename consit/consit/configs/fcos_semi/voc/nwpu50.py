...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/public/home/lsy/myj/code_dsl/NWPU/semivoc/prepared_annos/train_50.txt',
    ...
    unlabel_train=dict(
        ...
        ann_path= '/public/home/lsy/myj/code_dsl/data/semivoc/unlabel_prepared_annos/Industry/annotations/full2_nwpu50/',
        labelmapper = '/public/home/lsy/myj/code_dsl/NWPU/mmdet_category_info.json',
        img_prefix = '/public/home/lsy/myj/code_dsl/NWPU/VOC2007/JPEGImages/',
    ...
    unlabel_pred=dict(
        ...
        anno_root_path = '/public/home/lsy/myj/code_dsl/data/semivoc/unlabel_prepared_annos/Industry/annotations/full2_nwpu50/',
