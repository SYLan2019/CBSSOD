model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        pretrained='/home/scdx2/szc/consit/resnet50_rla_2283.pth.tar'),
        # type='ResNet',
        # depth=50,
        # num_stages=4,
        # out_indices=(0, 1, 2, 3),
        ...
        # init_cfg=dict(
        #     type='Pretrained',
        #     checkpoint='/home/scdx2/szc/consit/resnet50_msra-5891d200.pth')),
    neck=dict(
        type='FPN',
...
## consit style path; recommend to use absolute path
data_root = '/home/scdx2/szc/consit/data/semivoc/'
...
data = dict(
    ...
    unlabel_train=dict(
        ...
        ann_path=data_root + 'unlabel_prepared_annos/Industry/annotations/full2_dota100/',
        labelmapper = data_root + 'mmdet_category_info.json',
        img_prefix = data_root + 'unlabel_images/full/',
        pipeline = unlabel_train_pipeline,
        #myj 需要修改阈值，避免造成污染
        thres="adathres_2_dota100.json",
        ),
    unlabel_pred=dict(
        type=dataset_type,
        #myj 增加一个属性s
        ...
        image_list_file = '/home/scdx2/szc/consit/data/semivoc/unlabel_prepared_annos/Industry/voc12_trainval.txt',
        anno_root_path = data_root + 'unlabel_prepared_annos/Industry/annotations/full2_dota100/',
    ...
    val=dict(
        type='VOCDataset',
        ann_file='/home/scdx2/szc/consit/ori_data/VOCdevkit2007/VOC2007/ImageSets/Main/test.txt',
        img_prefix='/home/scdx2/szc/consit/ori_data/VOCdevkit2007/VOC2007',
        pipeline=test_pipeline),
    ...
    test=dict(
        type='VOCDataset',
        ann_file='/home/scdx2/szc/consit/ori_data/VOCdevkit2007/VOC2012/ImageSets/Main/unlabel_train.txt',
        img_prefix='/home/scdx2/szc/consit/ori_data/VOCdevkit2007/VOC2012',
        pipeline=test_pipeline)
)
# learning policy
optimizer = dict(type='AdamW', lr=0.00001, weight_decay=0.0001,paramwise_cfg=dict(bias_lr_mult=2., bias_decay_mult=0.))
