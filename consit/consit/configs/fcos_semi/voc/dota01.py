...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'prepared_annos/Industry/train_list01.txt',
    ...
    unlabel_train=dict(
        ...
        ann_path=data_root + 'unlabel_prepared_annos/Industry/annotations/full2_dota01/',
        labelmapper = data_root + 'mmdet_category_info.json',
        img_prefix = data_root + 'unlabel_images/full/',
        pipeline = unlabel_train_pipeline,
        #myj 需要修改阈值，避免造成污染
        thres="adathres_2_dota01.json",
        ),
    unlabel_pred=dict(
        type=dataset_type,
        #myj 增加一个属性s
        ...
        anno_root_path = data_root + 'unlabel_prepared_annos/Industry/annotations/full2_dota01/',
