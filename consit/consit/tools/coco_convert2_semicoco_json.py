...
def convert(args):
        print("Generating consit-style data dir")
        ...
        if not os.path.exists(os.path.join(args.output,'valid_images/full')):
                ...
                with open(os.path.join(args.output,'prepared_annos/Industry/valid_list.txt'),'w') as f:
                    for i in os.listdir(os.path.join(args.input,'val2017')):
                        ...
                        f.write(i + '\n')
        # for  annotations
        print("Converting original coco annotations to consit-style annotations")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output',type=str,default=None,help="consit-style semicoco data dir path: /gruntdata1/bhchen/factory/data/semicoco")
